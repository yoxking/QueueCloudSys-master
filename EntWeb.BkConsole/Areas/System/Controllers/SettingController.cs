...
namespace EntWeb.BkConsole.Areas.System.Controllers
{
    public class SettingController : frmMainController
    {
        ...
        public override ActionResult Index()
        {
            ...
            string wtcpPort = PublicHelper.GetConfigValue("MqServport");
        ...
        public void AjaxSave()
        {
            try
            {
                ...
                PublicHelper.SetConfigValue("MqServerip", sServerIp);
                PublicHelper.SetConfigValue("MqServport", sWtcpPort);
