...
namespace EntFrm.Framework.Utility
{
    public class OrlHelper
    {
        ...
        public static OracleConnection GetConnection(string connectionString)
        {
            ...
            {
                throw new Exception("创建数据库连接时出错;" + ex.Message);
            }
        }

        //生成分页MSSQL代码
        public static string GetSQL_Paging(SqlModel s_model)
        {
            try
            {
                int startNum = (s_model.iPageNo - 1) * s_model.iPageSize;
                int enditNum = startNum + s_model.iPageSize;

                string strWhere = (s_model.sCondition.ToLower() == "none" ? "" : s_model.sCondition);
                string strSql = "SELECT  " + s_model.sFields + "  FROM  (  SELECT a.*, ROWNUM RN   FROM (SELECT * FROM " + s_model.sTableName + strWhere + " Order By " + s_model.sOrderField + " " + s_model.sOrderType + " ) a   WHERE ROWNUM <= " + enditNum + "  )  WHERE RN >= " + startNum;

                return strSql;
            }
            catch (Exception ex)
            {
                throw new Exception("生成分页SQL语句时出错;" + ex.Message);
            }
        }

        public static string GetSQL_Count(SqlModel s_model)
        {
            try
            {
                string strSql = null;

                if (s_model.sCondition == null || s_model.sCondition == "")
                {
                    strSql = "Select count(*) From " + s_model.sTableName;
                }
                else
                {
                    strSql = "Select count(*) From " + s_model.sTableName + "  " + s_model.sCondition;
                }
            ...
            {
                throw new Exception("生成计量SQL语句时出错;" + ex.Message);
            }
        }
        ...
        public static int ExecuteNonQuery(OracleConnection conn, string cmdText)
        {
            ...
            catch (Exception ex)
            {
                if (conn.State != ConnectionState.Closed)
                    conn.Close();
                throw new Exception("执行(ExecuteNonQuery|)SQL语句时出错;" + ex.Message);
            }
        }

        public static int ExecuteNonQuery(OracleConnection conn, string cmdText, OracleParameter para)
        {
            try
            {
                conn.Open();
            ...
            catch (Exception ex)
            {
                if (conn.State != ConnectionState.Closed)
                    conn.Close();
                throw new Exception("执行(ExecuteNonQuery|para)SQL语句时出错;" + ex.Message);
            }
        }

        public static int ExecuteNonQuery(OracleConnection conn, string cmdText, OracleParameter[] paras)
        {
            try
            {
                conn.Open();
                OracleCommand cmd = new OracleCommand(cmdText, conn);
                int iParasLen = paras.Length;
                for (int i = 0; i < iParasLen; i++)
                {
            ...
            catch (Exception ex)
            {
                if (conn.State != ConnectionState.Closed)
                    conn.Close();
                throw new Exception("执行(ExecuteNonQuery|paras)SQL语句时出错;" + ex.Message);
            }
        }
        ...
        public static DataSet ExecuteDataSet(OracleConnection conn, string cmdText)
        {
            ...
            //{
            //    conn.Open();
            //    OracleDataReader da = new OracleDataReader(cmdText, conn);
            ...
            //    if (conn.State != ConnectionState.Closed)
            //        conn.Close();
            //    throw new Exception(" 执行(ExecuteDataSet)SQL语句时出错;" + ex.Message);
            //}
            return null;
        }
        ...
        public static DataSet ExecuteDataset(OracleConnection connection, CommandType commandType, string commandText, params OracleParameter[] commandParameters)
        {
            ...
            //using (OracleDataReader da = new OracleDataReader(cmd))
            //{
            //    DataSet ds = new DataSet();
        ...
        public static OracleDataReader ExecuteReader(OracleConnection conn, string cmdText)
        {
            ...
            catch (Exception ex)
            {
                if (conn.State != ConnectionState.Closed)
                    conn.Close();
                throw new Exception("执行(ExecuteReader|)SQL语句时出错;" + ex.Message);
            }

        }

        public static OracleDataReader ExecuteReader(OracleConnection conn, string cmdText, OracleParameter para)
        {
            try
            {
                conn.Open();
            ...
            catch (Exception ex)
            {
                if (conn.State != ConnectionState.Closed)
                    conn.Close();
                throw new Exception("执行(ExecuteReader|para)SQL语句时出错;" + ex.Message);
            }

        }

        public static OracleDataReader ExecuteReader(OracleConnection conn, string cmdText, OracleParameter[] paras)
        {
            try
            {
                conn.Open();
                OracleCommand cmd = new OracleCommand(cmdText, conn);
                int iParasLen = paras.Length;
                for (int index = 0; index < iParasLen; index++)
                {
                    cmd.Parameters.Add(paras[index]);
                }
                OracleDataReader dr = cmd.ExecuteReader(CommandBehavior.CloseConnection);
                paras = null;
                return dr;
            ...
            catch (Exception ex)
            {
                if (conn.State != ConnectionState.Closed)
                    conn.Close();
                throw new Exception("执行(ExecuteReader|paras)SQL语句时出错;" + ex.Message);
            }
        }

        public static OracleDataReader ExecuteReader_ByStoredProc(OracleConnection conn, string storedProcedureText, OracleParameter[] paras)
        {
            try
            {
                conn.Open();
            ...
            catch (Exception ex)
            {
                if (conn.State != ConnectionState.Closed)
                    conn.Close();
                throw new Exception("执行(ExecuteReader|StoredProcedure)SQL语句时出错;" + ex.Message);
            }
        }
        ...
        public static object ExecuteScalar(OracleConnection conn, string cmdText)
        {
            ...
            catch (Exception ex)
            {
                if (conn.State != ConnectionState.Closed)
                    conn.Close();
                throw new Exception("执行(ExecuteScalar|)SQL语句时出错;" + ex.Message);
            }
        }

        public static object ExecuteScalar(OracleConnection conn, string cmdText, OracleParameter para)
        {
            try
            {
                conn.Open();
            ...
            catch (Exception ex)
            {
                if (conn.State != ConnectionState.Closed)
                    conn.Close();
                throw new Exception("执行(ExecuteScalar|para)SQL语句时出错;" + ex.Message);
            }
        }

        public static object ExecuteScalar(OracleConnection conn, string cmdText, OracleParameter[] paras)
        {
            try
            {
                conn.Open();
            ...
            catch (Exception ex)
            {
                if (conn.State != ConnectionState.Closed)
                    conn.Close();
                throw new Exception("执行(ExecuteScalar|paras)SQL语句时出错;" + ex.Message);
            }
        }
            ...
            params OracleParameter[] commandParameters)
        {
            ...
            //// Create the DataAdapter & DataSet
            //using (OracleDataReader dataAdapter = new OracleDataReader(command))
            //{ 
        ...
        //    // Create a OracleDataReader, and dispose of it after we are done
        //    using (OracleDataReader dataAdapter = new OracleDataReader())
        //    {
        ...
        public static int ExecuteNonQueryTypedParams(String connectionString, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return OrlHelper.ExecuteNonQuery(connectionString, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return OrlHelper.ExecuteNonQuery(connectionString, CommandType.StoredProcedure, spName);
            }
        }
        ...
        public static int ExecuteNonQueryTypedParams(OracleConnection connection, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return OrlHelper.ExecuteNonQuery(connection, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return OrlHelper.ExecuteNonQuery(connection, CommandType.StoredProcedure, spName);
            }
        }
        ...
        public static int ExecuteNonQueryTypedParams(OracleTransaction transaction, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return OrlHelper.ExecuteNonQuery(transaction, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return OrlHelper.ExecuteNonQuery(transaction, CommandType.StoredProcedure, spName);
            }
        }
        #endregion
        ...
        public static DataSet ExecuteDatasetTypedParams(string connectionString, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return OrlHelper.ExecuteDataset(connectionString, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return OrlHelper.ExecuteDataset(connectionString, CommandType.StoredProcedure, spName);
            }
        }
        ...
        public static DataSet ExecuteDatasetTypedParams(OracleConnection connection, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return OrlHelper.ExecuteDataset(connection, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return OrlHelper.ExecuteDataset(connection, CommandType.StoredProcedure, spName);
            }
        }
        ...
        public static DataSet ExecuteDatasetTypedParams(OracleTransaction transaction, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return OrlHelper.ExecuteDataset(transaction, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return OrlHelper.ExecuteDataset(transaction, CommandType.StoredProcedure, spName);
            }
        }
        ...
        public static OracleDataReader ExecuteReaderTypedParams(String connectionString, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return OrlHelper.ExecuteReader(connectionString, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return OrlHelper.ExecuteReader(connectionString, CommandType.StoredProcedure, spName);
            }
        }
        ...
        public static OracleDataReader ExecuteReaderTypedParams(OracleConnection connection, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return OrlHelper.ExecuteReader(connection, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return OrlHelper.ExecuteReader(connection, CommandType.StoredProcedure, spName);
            }
        }
        ...
        public static OracleDataReader ExecuteReaderTypedParams(OracleTransaction transaction, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return OrlHelper.ExecuteReader(transaction, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return OrlHelper.ExecuteReader(transaction, CommandType.StoredProcedure, spName);
            }
        }
        #endregion
        ...
        public static object ExecuteScalarTypedParams(String connectionString, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return OrlHelper.ExecuteScalar(connectionString, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return OrlHelper.ExecuteScalar(connectionString, CommandType.StoredProcedure, spName);
            }
        }
        ...
        public static object ExecuteScalarTypedParams(OracleConnection connection, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return OrlHelper.ExecuteScalar(connection, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return OrlHelper.ExecuteScalar(connection, CommandType.StoredProcedure, spName);
            }
        }
        ...
        public static object ExecuteScalarTypedParams(OracleTransaction transaction, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return OrlHelper.ExecuteScalar(transaction, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return OrlHelper.ExecuteScalar(transaction, CommandType.StoredProcedure, spName);
            }
        }
        #endregion
        ...
        public static XmlReader ExecuteXmlReaderTypedParams(OracleConnection connection, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return OrlHelper.ExecuteXmlReader(connection, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return OrlHelper.ExecuteXmlReader(connection, CommandType.StoredProcedure, spName);
            }
        }
        ...
        public static XmlReader ExecuteXmlReaderTypedParams(OracleTransaction transaction, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return OrlHelper.ExecuteXmlReader(transaction, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                return OrlHelper.ExecuteXmlReader(transaction, CommandType.StoredProcedure, spName);
            }
        }
        #endregion
    }
