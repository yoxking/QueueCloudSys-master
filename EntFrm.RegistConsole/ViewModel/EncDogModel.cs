...
namespace EntFrm.RegistConsole
{
    public class EncDogModel
    {
        ...
        public EncDogModel(string encDogId, string organizName, string updateDate,string activeDate, string activeCount,string activeValCode)
        {
